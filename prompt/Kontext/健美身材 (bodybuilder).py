...
# -*- coding: utf-8 -*-
"""
Bodybuilder - Prompt Instructions
"""
...
要求在保持相同姿势和上下文的同时大幅增加主体的肌肉。在视觉上描述如何编辑主体，使他们变成健美运动员并拥有这些夸张的大肌肉：二头肌、腹肌、三头肌等。你可以改变衣服以确保它们展示过度肌肉化、夸张的身体。
