...
| -------- | -------- | -------- | ------ | -------- | ---- |
| `selection` | - | COMBO | `1:1` | `1:1` / `1:4` / `1:8` / `2:3` / `3:2` / `3:4` / `4:1` / `4:3` / `4:5` / `5:4` / `8:1` / `9:16` / `16:9` / `21:9` | 手动选择的 Gemini 3.1 Flash 比例预设；未连接 `image` 时直接输出此值。 |
...
- 输出比例包含 Gemini 3.1 Flash 的极端比例，如 `1:8`、`4:1`、`8:1`。
